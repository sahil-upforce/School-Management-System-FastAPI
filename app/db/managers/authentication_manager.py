...
class PermissionManager:
    ...
    def get_create_permission(table_names):
        return PermissionManager.get_permission_with_postfix(
            table_names=table_names, postfix="create"
        )

    @staticmethod
    def get_read_permission(table_names):
        return PermissionManager.get_permission_with_postfix(
            table_names=table_names, postfix="read"
        )

    @staticmethod
    def get_update_permission(table_names):
        return PermissionManager.get_permission_with_postfix(
            table_names=table_names, postfix="change"
        )

    @staticmethod
    def get_delete_permission(table_names):
        return PermissionManager.get_permission_with_postfix(
            table_names=table_names, postfix="delete"
        )
